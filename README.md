...
To subscribe for sdk logs create instance of DevinoLogsCallback this way:
...
You can get notification permission with:
...
```
int REQUEST_CODE = <SOME CODE>
DevinoSdk.getInstance().requestNotificationPermission(this, REQUEST_CODE);
```
...
### Basic address of the API

The method allows you to set the new basic address of the API:

```
DevinoSdk.getInstance().updateBaseApiUrl(newBaseApiUrl, context);
```
